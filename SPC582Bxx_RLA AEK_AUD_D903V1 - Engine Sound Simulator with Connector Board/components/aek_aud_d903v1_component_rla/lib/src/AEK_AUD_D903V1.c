...
/**
 * @brief   	This function sets the slow slope PWM configuration. Please observe that thermal warning shift -15 �C (IB12[D7] = 1) is required.
 *
 * @param[in]  	AEK_AUD_D903V1_DEVICE dev
 *
 * @return   	i2c_result_t
...
i2c_result_t AEK_903D_SetSlowSlopePWMConfiguration(AEK_AUD_D903V1_DEVICE dev)
{
	...
	{
		AEK_903D_Read_IB(dev, IB11,&FDA903D_Status_IB[dev][11],1);
		/*The slow slope PWM requires thermal warning shift -15 �C*/
 ...
 * @param[in]	value (Choose one of these parameters and copy it into the 'value' field of the function):
 *
 *		-	IB14_LC_FILTER_1_OUTPHASE 		(10 �H + 2.2 �F Out Phase)
 *     	-	IB14_LC_FILTER_1_INPHASE 		(10 �H + 2.2 �F In Phase)
 *     	-	IB14_LC_FILTER_2_OUTPHASE		(10 �H + 3.3 �F In Phase)
 *     	-	IB14_LC_FILTER_2_INPHASE 		(10 �H + 3.3 �F In Phase)
 *     	-	IB14_LC_FILTER_3_OUTPHASE		(10 �H + 4.7 �F In Phase)
 *		-	IB14_LC_FILTER_3_INPHASE 		(10 �H + 4.7 �F In Phase)
 *
 * @return     	i2c_result_t
 *
 * @api
