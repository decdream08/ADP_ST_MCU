...
static spc_mscr_io_init_t spc_mscr_io_init[] = {
  ...
  {(int16_t)MSCR_IO_PIN_DSP_MP0_GPIO33, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
  {(int16_t)MSCR_IO_PIN_DSP_RESET_GPIO44, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(2) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW}, //KMS241023_1 : Changed Default State from High to Low due to DSP selfboot. //PAL_HIGH}, //KMS240926_3 : Defuault State change to High and OERC to Strong Drive
  ...
  {(int16_t)MSCR_IO_PIN_MCU_AMP_DIAG_EIRQ10, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_IBE), PAL_LOW},
  {(int16_t)MSCR_IO_PIN_AMP_EN2_GPIO35, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(2) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW}, //KMS240926_2 : Change OERC to Strong Drive
  {(int16_t)MSCR_IO_PIN_AMP_MUTE_GPIO36, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_HIGH}, //KMS240926_1 : Defuault State change to High for MUTE
  ...
  {(int16_t)MSCR_IO_PIN_A2B_IRQ_3_GPIO60, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
  {(int16_t)MSCR_IO_PIN_A2B_IRQ_4_GPIO61, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
  {(int16_t)MSCR_IO_PIN_A2B_IRQ_1_GPIO62, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
  {(int16_t)MSCR_IO_PIN_A2B_IRQ_2_GPIO63, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
  ...
  {(int16_t)MSCR_IO_PIN_DSP_MP1_GPIO66, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
  {(int16_t)MSCR_IO_PIN_DSP_SOURCE_CHANGE_GPIO82, (iomode_t)(PAL_SPC5_SSS(0) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(1) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_HIGH}, //KMS241112_1 : Defuault State change to High for Source Change DSP
  {(int16_t)MSCR_IO_PIN_DSP_SPI_CS1_1, (iomode_t)(PAL_SPC5_SSS(1) | PAL_SPC5_OERC(0) | PAL_SPC5_ODC(2) | PAL_SPC5_SMC | PAL_SPC5_ILS(0) | PAL_SPC5_IBE), PAL_LOW},
